  ...
  CREATE TABLE AMO.AM_SCRIPT_SET 
   (	SET_ID VARCHAR2(30 CHAR), 
	...
	TITLE VARCHAR2(30 CHAR), 
	 CONSTRAINT PK_AM_SCRIPT_SET PRIMARY KEY (SET_ID, SCRIPT_ID, DATABASE_NAME) ENABLE
   ) ORGANIZATION INDEX;

   COMMENT ON TABLE AMO.AM_SCRIPT_SET  IS 'Group scripts for specific database together for 1 report';
...
--------------------------------------------------------
  ...
  ALTER TABLE AMO.AM_SCRIPT_SET ADD CONSTRAINT FK_SCRSET_DB FOREIGN KEY (DATABASE_NAME)
	  REFERENCES AMO.AM_DATABASE (DATABASE_NAME) ENABLE;
