...
--------------------------------------------------------
--  DDL for Table AM_SCRIPT_SET_COMPONENT
--------------------------------------------------------

CREATE TABLE AMO.AM_SCRIPT_SET_COMPONENT 
   (	SET_ID        VARCHAR2(30 CHAR), 
	SCRIPT_ID     VARCHAR2(30 CHAR), 
	DATABASE_NAME VARCHAR2(30 CHAR), 
	DISABLED      CHAR(1 CHAR) DEFAULT 'N', 
  ...
  CREATE INDEX AMO.AM_SCRSETCOMP ON AMO.AM_SCRIPT_SET_COMPONENT (SET_ID, SCRIPT_ID) ;

   COMMENT ON TABLE AMO.AM_SCRIPT_SET_COMPONENT IS 'Component details for group scripts';

  GRANT UPDATE ON AMO.AM_SCRIPT_SET_COMPONENT TO AMU;
  GRANT SELECT ON AMO.AM_SCRIPT_SET_COMPONENT TO AMU;
  GRANT INSERT ON AMO.AM_SCRIPT_SET_COMPONENT TO AMU;
  GRANT DELETE ON AMO.AM_SCRIPT_SET_COMPONENT TO AMU;
...
--------------------------------------------------------
--  DDL for Index AM_SCRSET
--------------------------------------------------------

  CREATE UNIQUE INDEX AMO.AM_SCRSET ON AMO.AM_SCRIPT_SET (SET_ID) ;
--------------------------------------------------------
--  DDL for Index AM_SCRSET
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE AMO.AM_SCRIPT_SET ADD CONSTRAINT SCRSET_PK PRIMARY KEY (SET_ID) USING INDEX;
...
--------------------------------------------------------
  ...
  ALTER TABLE AMO.AM_SCRIPT_SET ADD CONSTRAINT FK_SCRSET_SCRIPT FOREIGN KEY (SCRIPT_ID)
	  REFERENCES AMO.AM_SCRIPTS (SCRIPT_ID) ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table AM_SCRIPT_SET_COMPONENT
--------------------------------------------------------

  ALTER TABLE AMO.AM_SCRIPT_SET_COMPONENT ADD CONSTRAINT SCRSET_FK FOREIGN KEY (SET_ID)
	  REFERENCES AMO.AM_SCRIPT_SET (SET_ID) ENABLE;
--------------------------------------------------------
